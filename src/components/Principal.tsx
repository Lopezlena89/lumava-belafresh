    ...
    <>
        <section className="w-full h-auto bg-red-100 flex flex-col sm:flex-row  ">
            <div className="w-full sm:w-[50%] h-[500px] bg-red-200 flex justify-center items-center">
                <div className="w-[60%] md:w-[70%] h-[50%] md:h-[70%] flex flex-col justify-around texto">
                    <h2 className="text-[#864232] text-5xl md:text-7xl font- text-start">Lo natural es mejor</h2>
                    <h3 className="text-[#864232] text-lg md:text-2xl font- text-start">Productos organicos y naturales, libres de crueldad animal</h3>
