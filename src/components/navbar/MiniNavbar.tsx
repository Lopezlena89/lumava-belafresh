      ...
      >
       ...
       <div className="pt-10 w-full h-full flex flex-col justify-between texto">
          <nav className="h-auto w-full list-none font-medium">
            <li className="border-b border-solid border-red-300"><Link href="#nosotros" className="pl-2 lg:mr-[2%]  h-14  hover:text-[#eeb9b9] text-[#ca8a8a] md:text-[0.7em] lg:text-[0.8em] " >Nosotros</Link></li>
            <li className="border-b border-solid border-red-300 "><Link href="#categories" className="pl-2 h-14  hover:text-[#eeb9b9] text-[#ca8a8a] md:text-[0.7em] lg:text-[0.8em] " >Nuestros productos</Link></li>
            <li className="border-b border-solid border-red-300 "><Link href="#ubicacion" className="pl-2 h-14  hover:text-[#eeb9b9] text-[#ca8a8a] md:text-[0.7em] lg:text-[0.8em] " >Ubicacion</Link></li>
          </nav>
