...
export const ImagenCategoria = ({categoria}:Props)=>{
  ...
  return (
    <>
        <div className="w-full h-[230px] p-5 my-5 flex justify-center items-center overflow-hidden relative">
            <Image
            ...
            <div className="absolute w-[150px] h-full z-10 bottom-0 left-12 lg:left-16 flex flex-col justify-center ">
                <h3 className="text-[#864232] pl-2 text-2xl font-medium">{categoria.categoria}</h3>
                <Button
                onPress={handleOpen}
                    className="bg-red-300 mt-3 text-[#864232] text-lg font-semibold rounded-md">
                    Ver productos
                </Button>
            </div>
        </div>
